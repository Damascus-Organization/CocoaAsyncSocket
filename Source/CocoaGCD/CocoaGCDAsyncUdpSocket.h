...
extern NSString *const CocoaGCDAsyncUdpSocketException;
extern NSString *const CocoaGCDAsyncUdpSocketErrorDomain;

extern NSString *const CocoaGCDAsyncUdpSocketQueueName;
extern NSString *const CocoaGCDAsyncUdpSocketThreadName;

typedef NS_ERROR_ENUM(CocoaGCDAsyncUdpSocketErrorDomain, CocoaGCDAsyncUdpSocketError) {
	CocoaGCDAsyncUdpSocketNoError = 0,          // Never used
	CocoaGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	CocoaGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	CocoaGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	CocoaGCDAsyncUdpSocketClosedError,          // The socket was closed
	CocoaGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class CocoaGCDAsyncUdpSocket;

@protocol CocoaGCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(CocoaGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(CocoaGCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(CocoaGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(CocoaGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(CocoaGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(CocoaGCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * Example:
 * 
 * CocoaGCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^CocoaGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^CocoaGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface CocoaGCDAsyncUdpSocket : NSObject

/**
 * CocoaGCDAsyncUdpSocket uses the standard delegate paradigm,
...
- (instancetype)initWithDelegate:(nullable id<CocoaGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<CocoaGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<CocoaGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<CocoaGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<CocoaGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<CocoaGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<CocoaGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<CocoaGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means CocoaGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, CocoaGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, CocoaGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, CocoaGCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that CocoaGCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about CocoaGCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable CocoaGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable CocoaGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * CocoaGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, CocoaGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about CocoaGCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable CocoaGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable CocoaGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The CocoaGCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally CocoaGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
